...
# ffmpeg -f image2 -i 15526594522_ba001951b9_c.bmp -i tiffany-cover.wav -q:v 5 -acodec libvorbis -vcodec vp8 -s 800x600 "$out"
ffmpeg -loop 1 -f image2 -i krishna1.jpg -i Recording_41.mp3 -shortest -q:v 5 -s 800x600 "$out"
